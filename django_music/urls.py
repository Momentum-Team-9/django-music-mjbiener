...
urlpatterns = [
    ...
    path('', core_views.album_list, name ='albums'),
    path('albums/new', core_views.add_album, name ='add_album'),
    path('albums/<int:pk>', core_views.album_detail, name ='album_details'),
